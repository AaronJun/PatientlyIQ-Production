<script lang="ts">
  ...
  interface $$Props extends Omit<HTMLAttributes<HTMLDivElement>, 'class'> {
     ...
     */
    subheaderSpacingScale?: number;
  }

  export let size: $$Props["size"] = "m";
  export let subheaderSpacingScale: $$Props["subheaderSpacingScale"] = undefined;
...
<div 
  class={cn("text-set", size && `text-set--${size}`, className)} 
  style={customStyle}
  {...$$restProps}
>
  {#if $$slots.subheader}
