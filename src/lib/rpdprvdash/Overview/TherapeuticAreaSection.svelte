...
>
    ...
    <div class="flex flex-col md:flex-row gap-4 md:gap-8 lg:gap-16 w-full lg:w-2/5">
        <div class="flex flex-col md:flex-row items-start gap-8 align-top">
            ...
            <Button.Root class="rounded-input flex-row gap-2 border-1 border-slate-800 text-slate-800 text-left text-sm shadow-mini hover:bg-slate-200 inline-flex w-full px-4 py-2 h-12 place-items-center justify-between font-semibold active:scale-[0.98] active:transition-all">
